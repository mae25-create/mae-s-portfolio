...
const XiaohongshuIcon = () => (
  <svg viewBox="0 0 200 200" width="28" height="28">
    ...
    <text x="100" y="78" textAnchor="middle" dominantBaseline="central" fill="var(--background, #FAFAFA)" fontSize="42" fontWeight="700" fontFamily="sans-serif">小红</text>
    <text x="100" y="128" textAnchor="middle" dominantBaseline="central" fill="var(--background, #FAFAFA)" fontSize="42" fontWeight="700" fontFamily="sans-serif">书</text>
  </svg>
);
const WechatIcon = () => (
