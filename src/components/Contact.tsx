...
const XiaohongshuIcon = () => (
  <svg viewBox="0 0 24 24" width="28" height="28" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.5 14.5h-2v-3h-3v3h-2v-7h2v2.5h3V9.5h2v7z"/></svg>
);
const WechatIcon = () => (
