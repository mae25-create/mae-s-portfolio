...
const XiaohongshuIcon = () => (
  <svg viewBox="0 0 200 200" width="28" height="28" fill="currentColor">
    <path d="M100 16C53.6 16 16 53.6 16 100s37.6 84 84 84 84-37.6 84-84S146.4 16 100 16z" fill="#FF2442"/>
    <path d="M69.2 68h15.6l5.2 24.8L95.6 68h15.2l-12 52H84.4l-5.6-26.4L73.2 120H58.8l10.4-52zm48 0H132v10.4h-14.8V120h-14.4V78.4H88l29.2-10.4z" fill="white"/>
  </svg>
);
const WechatIcon = () => (
